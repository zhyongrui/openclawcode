...
export type SessionsReattachParams = SchemaType<"SessionsReattachParams">;
...
export type ToolsDiffParams = SchemaType<"ToolsDiffParams">;
export type ToolsDiffResponse = SchemaType<"ToolsDiffResponse">;
