...
export const ProtocolSchemas = {
  ...
  SessionsReattachParams: SessionsReattachParamsSchema,
  ...
  ToolsDiffParams: ToolsDiffParamsSchema,
  ToolsDiffResponse: ToolsDiffResponseSchema,
