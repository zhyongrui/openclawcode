...
- command-layer issue `#116` for `issueNumber` has now also been
  implemented, documented, and auto-closed through the same path
- command-layer issue `#117` for `issueUrl` has now also been
  implemented, documented, and auto-closed through the same path
- command-layer issue `#118` for `issueLabelCount` has now also been
  implemented, documented, and auto-closed through the same path
- command-layer issue `#119` for `issueHasLabels` has now also been
  implemented, documented, and auto-closed through the same path
- command-layer issue `#120` for `publishedPullRequestUrl` has now also been
  implemented, documented, and auto-closed through the same path
- command-layer issue `#121` for `publishedPullRequestBaseBranch` has now also
  been implemented, documented, and auto-closed through the same path
- command-layer issue `#122` for `publishedPullRequestBranchName` has now also
  been implemented, documented, and auto-closed through the same path
- validation-pool tooling now continues with command-layer issue `#123` for
